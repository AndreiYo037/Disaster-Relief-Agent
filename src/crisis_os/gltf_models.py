...
PARTS: dict[str, list[tuple[float, float, float, float, float, float]]] = {
    # Twin Span: deck on two pylons
    "bridge": [
        (0, 12, 0, 220, 3.5, 12),   # deck
        (-70, 6, 0, 8, 12, 10),     # pylon W
        (0, 6, 0, 8, 12, 10),
        (70, 6, 0, 8, 12, 10),      # pylon E
    ],
    "bridge.failed": [
        (-55, 4, 4, 90, 2.5, 12),   # west deck dropped
        (60, 1.5, -6, 85, 2.5, 12), # east deck off pylons
        (-70, 6, 0, 8, 12, 10),
        (0, 4, 0, 8, 8, 10),
        (70, 5, 0, 8, 10, 10),
    ],
